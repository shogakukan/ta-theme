<div class="container">
    ...
    <div class="footer-content d-flex flex-column flex-lg-row justify-content-between my-3 mt-md-4 mb-md-5">
        ...
        <div class="col-12 col-lg-7">
            ...
            <p class="mb-0"><span class="ta-celeste-color">Edición Nº <?php echo get_option( 'datos_footer_option_name' )['n_edicin_3']?></span> / <?php echo date_i18n('j') . " de " . date_i18n('F') . " de " . date_i18n('Y'); ?></p>
